...
function Recommendation() {
            ...
            <Col xs={12} sm={6} md={6} lg={4} xl={3} className="mb-4" key={i}>
                <Card style={{ height: '100%' }}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Link href="/detail" target="_blank" className='link-underline link-underline-opacity-0 link-primary fw-semibold'>read more...</Card.Link>
                    </Card.Body>
                </Card>
            </Col>
        ));
    ...
    return (
        <Container className="my-5">
            <h4 className='my-5 fw-semibold label'>Rekomendasi Untuk Anda</h4>
            {loading && <p>Loading...</p>}
